...
/**
 * Bu sınıf Huawei telefon markası için bu markaya ait fiyatının hesaplandığı sınıftır.
 * @author Süreyya
 * @Date 17.11.2022
 * @since 0.0.1
 * @version 0.0.1
...
public class HuaweiPhoneManager extends BasePhoneManager {
     ...
     */
    public HuaweiPhoneManager(String markaBilgileri, String firmaBilgileri) {
